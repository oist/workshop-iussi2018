...
#Laurent Excoffier Ocotober 2016
#
# This script will launch several simulations with fsc26 and recording computation times
...
coreOptions=-c1
echo "-t 1PopExpInst20Mb.tpl -e 1PopExpInst20Mb.est -d -M -n$numSims -I -L$numCycles --seed 1234 -q $coreOptions $batchOptions" > threadsSpeedTestEst.txt
echo "testing 1PopExpInst20Mb   ($coreOptions and $batchOptions)"
cd 1PopExpInst20Mb
( time ../$fsc -t 1PopExpInst20Mb.tpl -e 1PopExpInst20Mb.est -d -M -n$numSims -I -L$numCycles --seed 1234 -q $coreOptions $batchOptions ) 2>>../threadsSpeedTestEst.txt
cd ..
